...
import com.mxme.io.BufferedReader;
...
public class CSVReader
{
    ...
    public Vector readAll() throws IOException
    {
        ...
        while( hasNext )
        {
            Vector nextLineAsTokens = readNext();
     ...
     *             if bad things happen during the read
     */
    public Vector readNext() throws IOException
    {
     ...
     */
    private Vector parseLine(String nextLine) throws IOException
    {
        if (nextLine == null)
            return null;
