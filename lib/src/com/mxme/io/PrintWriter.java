 ...
 *
 * Adaptation to J2ME by Matias Pequeno
 */
package com.mxme.io;
 ...
 * @todo since I had to remove the generic Thread.interrput() calls, this may not be 100% thread safe.
 *
 ...
 *      CharSequence methods just receive a String
 */
...
public class PrintWriter extends Writer
{
     ...
     * @since 1.5
     */
    public PrintWriter append(String csq)
    {
        if( csq == null )
            write("null");
        else
     ...
     * @since 1.5
     */
    public PrintWriter append(String csq, int start, int end)
    {
        String cs = (csq == null ? "null" : csq);
